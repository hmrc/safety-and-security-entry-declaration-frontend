...
class NumberOfPiecesFormProviderSpec extends IntFieldBehaviours {

  val form = new NumberOfPiecesFormProvider()()
  ...
  ".value" - {
    ...
    behave like mandatoryField(
      form,
      fieldName,
      requiredError = FormError(fieldName, "numberOfPieces.error.required")
    )
  }
}
