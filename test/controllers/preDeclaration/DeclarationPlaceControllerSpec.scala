...
import forms.preDeclaration.DeclarationPlaceFormProvider
import models.NormalMode
import org.mockito.ArgumentMatchers.{any, eq => eqTo}
import org.mockito.Mockito.{times, verify, when}
import org.scalatestplus.mockito.MockitoSugar
import pages.preDeclaration.DeclarationPlacePage
import play.api.inject.bind
import play.api.test.FakeRequest
import play.api.test.Helpers._
import repositories.SessionRepository
import views.html.preDeclaration.DeclarationPlaceView

import scala.concurrent.Future

class DeclarationPlaceControllerSpec extends SpecBase with MockitoSugar {
  ...
  "DeclarationPlace Controller" - {
    ...
    "must save the answer and redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        val result = route(application, request).value
        val expectedAnswers = emptyUserAnswers.set(DeclarationPlacePage, "answer").success.value
