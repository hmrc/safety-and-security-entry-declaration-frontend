...
import viewmodels.checkAnswers.routedetails.{PlaceOfLoadingSummary, PlaceOfUnloadingSummary}
...
class AddPlaceOfUnloadingControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val addPlaceOfUnloadingRoute = routes.AddPlaceOfUnloadingController.onPageLoad(NormalMode, lrn).url
  ...
  "AddPlaceOfUnloading Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        val list = PlaceOfUnloadingSummary.rows(emptyUserAnswers)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual AddPlaceOfUnloadingPage.navigate(NormalMode, emptyUserAnswers, true).url
      }
    }
