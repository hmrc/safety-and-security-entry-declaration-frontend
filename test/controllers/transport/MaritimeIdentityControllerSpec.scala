...
import views.html.transport.MaritimeIdentityView
...
class MaritimeIdentityControllerSpec extends SpecBase with MockitoSugar {
  ...
  "MaritimeIdentity Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, maritimeIdentityRoute)

        val view = application.injector.instanceOf[MaritimeIdentityView]
