...
class CommodityCodeKnownController @Inject() (
  ...
  def onPageLoad(waypoints: Waypoints, lrn: LocalReferenceNumber, index: Index): Action[AnyContent] =
    cc.authAndGetData(lrn) { implicit request =>
      ...
      val preparedForm = request.userAnswers.get(CommodityCodeKnownPage(index)) match {
        case None => form
      ...
      form
        ...
        .fold(
          ...
          value =>
            ...
            } yield Redirect(CommodityCodeKnownPage(index).navigate(waypoints, updatedAnswers))
        )
    }
}
