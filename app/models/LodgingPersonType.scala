...
sealed trait LodgingPersonType

object LodgingPersonType extends Enumerable.Implicits {

  case object Carrier extends WithName("carrier") with LodgingPersonType
