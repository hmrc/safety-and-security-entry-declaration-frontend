...
object DocumentType {
  ...
  val allDocumentTypes: Seq[DocumentType] =
    Seq(
      ...
      DocumentType("A119", """Airworthiness certificate or declaration in the commercial invoice cont. the elements of the airworthiness certif. issued or a doc. Annexed"""),
      ...
      DocumentType("C028", """Invoice declaration bearing :"Specific origin rule laid down in Dec. No 2/2000 of EC-Mexico Joint Council Annex III App. IIa Note 12.1""""),
      DocumentType("C031", """Statement with the following form "ILO Conventions No 29, 87, 98, 100, 105, 111, 138 and 182 - Titel III of Regulation (EC) No 2501/01""""),
      ...
      DocumentType("C049", """Supplementary document as mentioned in Reg. (EC) No 1100/2006 (OJ L 196)"""),
      DocumentType("C050", """Certificate Reg.1234/2007"""),
      DocumentType("C051", """Declaration by the Food-veterinary and environmental agency of Faeroe islands, issued in accordance with Regulation (EC) No 1381/2007"""),
      ...
      DocumentType("C633", """Certif. of indust. use for  fruit and vegetab. subject to comm. marketing stand. in acc. with Art. 19(2) and Annex V of Reg. (EC) 1580/2007"""),
      ...
      DocumentType("C640", """Common veterinary entry document (CVED) in accordance with Regulation (EC) No. 282/2004, used for veterinary checks on live animals"""),
      ...
      DocumentType("D009", """Import auth. issued in acc. with Reg. 1818/2006 in rel. with anti-dumping measures on imp. of potassium chloride origin. in Belarus"""),
      DocumentType("D010", """(Non-customised) multi-comb. forms of DRAMs orig. in count. other than the Rep. of Korea or orig. in the Rep. of Korea and manuf. by Samsung"""),
      DocumentType("D011", """DRAM containing products of KR origin other than from Samsung <|10% of the value"""),
      DocumentType("D012", """DRAM containing products of KR origin other than from Samsung >=|10% <|20% of the value"""),
      DocumentType("D013", """DRAM containing products of KR origin other than from Samsung >=|20% <|30% of the value"""),
      DocumentType("D014", """DRAM containing products of KR origin other than from Samsung >=|30% <|40% of the value"""),
      DocumentType("D015", """DRAM containing products of KR origin other than from Samsung >=|40% <|50% of the value"""),
      DocumentType("D016", """DRAM containing products of KR origin other than from Samsung >=|50% of the value"""),
      ...
      DocumentType("E016", """Export document issued by the competent Czech authorities(Regulation (EC) No ^  925/2003-L 131)"""),
      ...
      DocumentType("L108", """Import lic. with the following entries: the country or countries of origin, the quantity of raw sugar, expressed as white sugar equivalent"""),
      ...
      DocumentType("N002", """Certif. of conf. with the comm. marketing stand. for fruit and vegetables, in acc. with Art. 11,12 and Annex III of Reg. (EC) 1580/2007"""),
      ...
      DocumentType("N853", """Common Veterinary Entry Document (CVED) in accordance with Regulation (EC) No. 136/2004, used for veterinary check on products."""),
      ...
      DocumentType("U002", """Certificate of origin for imports of agricultural products into the European Community."""),
      ...
      DocumentType("U019", """Certificate EUR.1 bearing:"Specific origin rule laid down in Dec. No 2/2000 of EC-Mexico Joint Council Annex III Appendix IIa Note 12.1""""),
      ...
      DocumentType("U027", """Certif. of orig. Form A bear. "Quota order No 09.4305-Reg(EC) No 1381/2002" the date of load. of sugar, the marketing year, CN code 17011110"""),
      DocumentType("U028", """Certif. of orig. Form A bear.."Regulation (EC) No 964/2007"; the date of loading of the rice, the marketing year, CN code 1006"""),
      DocumentType("U030", """Statement with the following  "ILO Conventions No 29, 87 ,98, 100, 105, 111, 138 and 182 - Title III of Reg.(EC) No 2501/01""""),
      ...
      DocumentType("U038", """The proof of origin shall contain the following mention: "sheep product/s from the species domestic sheep""""),
      DocumentType("U039", """The proof of origin shall contain the following mention: "from the species other than domestic sheep""""),
      DocumentType("U040", """Proof of orig. est. in acc. with Art. 47 of Reg.(EEC) No 2454/93, inc. CN code, the order num.of tariff quota, the total net weight"""),
      DocumentType("U041", """Certificate EUR.1 1/2005 (CV)"""),
      DocumentType("U042", """Certificate EUR.1 2/2005"""),
      DocumentType("U043", """Certificate EUR.1 bearing the endorsement "Derogation-Commission Decision 2005/578/EC" or "Dérogation-Décision 2005/578/CE de la Commission""""),
      ...
      DocumentType("U090", """Certificate EUR 1,stating EC origin, in the context of the agreement between the European Economic Community and the Swiss Confederation"""),
      DocumentType("U091", """Invoice declaration, stating EC origin in the context of the agreement beetween the European Economic Community and the Swiss Confederation"""),
      ...
      DocumentType("Y010", """Products must meet rel. req. of Reg.(EC) 852/2004 and 853/2004, compl. with health marking req. laid in AnnexII, Sec.I of Reg.(EC) 853/2004"""),
      DocumentType("Y011", """Prod. must meet req. of Reg(EC) 852/2004 and 853/2004, compl. with the health marking req. laid in Annex I, Sec.I, Ch.III of Reg(EC)854/2004"""),
      DocumentType("Y013", """Insertion of following end. in the "Remarks" of goods movement certificate. Reg(EEC) 1518/76 (OJ L 169/37):Special export charge collected"""),
      DocumentType("Y015", """The rough diamonds are cont. in tamper-resistant containers and seals applied at export by the participant(Kimberley process) are not broken"""),
      ...
      DocumentType("Y040", """The VAT id. no. issued in MS of importation for the importer design. or recognised under Art.201 of  VAT  Dir. as liable for payment of  VAT"""),
      DocumentType("Y041", """The VAT id no of the customer  who is liable for the VAT on the intra-Community acquisition of goods in accordance with Art.200 of VAT Dir"""),
      ...
      DocumentType("Y905", """Goods that will be used for exclusive purpose of public display in museum in view of their historic significance or medical-technical goods"""),
      DocumentType("Y906", """Goods not in the TR footnotes (708)"""),
      DocumentType("Y907", """Goods to be used by military or civil personnel of MS, taking part in EU or UN peace keeping or crisis man. op. in the 3 country of dest"""),
      DocumentType("Y908", """Exp.to terr.of MS(Greenl., New Cal. and Dep, FR Polyn, FR Sth and Antarctic Terr, Wallis, Futuna Is, Mayotte, St Pierre, Miquelon, Büsingen)"""),
      ...
      DocumentType("Y924", """Goods other than metallic mercury as mentioned by Regulation (EC) No 1102/2008"""),
