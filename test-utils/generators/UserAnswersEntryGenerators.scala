...
trait UserAnswersEntryGenerators extends PageGenerators with ModelGenerators {
  ...
  implicit lazy val arbitraryTransportCountryOriginUserAnswersEntry: Arbitrary[(TransportCountryOriginPage.type, JsValue)] =
    Arbitrary {
      for {
        page  <- arbitrary[TransportCountryOriginPage.type]
